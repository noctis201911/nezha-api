...
Route::get('merchant-two-factor/challenge', [MerchantTwoFactorController::class, 'challenge'])->name('merchant.2fa.challenge');
Route::post('merchant-two-factor/challenge', [MerchantTwoFactorController::class, 'verifyChallenge'])->name('merchant.2fa.verify');
