...
<div class="card-header">
    <h5 class="card-header-title">
        <img src="{{dynamicAsset('assets/admin/img/dashboard/statistics.png')}}" alt="dashboard" class="card-header-icon">
                ...
                <div class="grid-card min-height-100">
                    ...
                    <div class="text-center py-3 mt-6">
                        <img class="initial-41 onerror-image" data-onerror-image="{{dynamicAsset('assets/admin/img/160x160/img1.jpg')}}"
                             src="{{ $item->image_full_url ?? dynamicAsset('assets/admin/img/160x160/img1.jpg')}}">
                    </div>
