        ...
        <div class="page-header d-flex flex-wrap align-items-center justify-content-between">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{dynamicAsset('assets/admin/img/Create_Cashback_Offer.png')}}" class="w--26" alt="">
                </span>
                <span>
                        ...
                        <form id="cashback-submit" action="{{route('admin.cashback.store')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6" id="customer_wise">
                                    <div class="form-group counter__unique-wrap">
                                        ...
                                        <select name="customer_id[]" id="select_customer"
                                                ...
                                                multiple class="form-control w-100 this-multile-select js-data-example-ajax-2">
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label" for="max_discount">{{translate('messages.Maximum_Discount')}} ({{ \App\CentralLogics\Helpers::currency_symbol() }}) <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="1" required  value="{{  old('same_user_limit') }}" name="same_user_limit" value="0" min="1" max="9999999" class="form-control"
...
@push('script_2')
<script src="{{dynamicAsset('assets/admin')}}/js/view-pages/cashback-index.js"></script>
<script>
    "use strict";
