            ...
            <div class="card-body" id="form_data">
                <form action="{{route('admin.cashback.update',['id'=>$cashback?->id ])}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col-md-4 col-lg-4 col-sm-6" >
                            <div class="form-group counter__unique-wrap" id="customer_wise">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="1" name="same_user_limit" value="{{ $cashback->same_user_limit }}"  value="0" min="1" max="9999999" class="form-control" required
