                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="nezha_cs" class="form-check-input"
                                    id="nezha_cs">
                            <label class="form-check-label ml-2 ml-sm-3  text-dark" for="nezha_cs">{{translate('AI在线客服')}}</label>
                        </div>
                    </div>
                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="system_settings" class="form-check-input"
                                    id="system_settings">
                            <label class="form-check-label ml-2 ml-sm-3  text-dark" for="system_settings">{{translate('messages.system_settings')}}</label>
                        </div>
                    </div>
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="system_addon" class="form-check-input"
                                    id="system_addon">
                            <label class="form-check-label ml-2 ml-sm-3  text-dark" for="system_addon">{{translate('messages.system_addon')}}</label>
                        </div>
                    </div>
                </div>
