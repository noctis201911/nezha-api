...
<form class="validate-form" action="{{ route('admin.react_landing_page.reactFaqUpdate',[$faq['id']]) }}" method="post"
                        ...
                        @if ($language)
                            <div class="form-group lang_form1" id="default-form1">
                                <div class="col-md-12">
                                    ...
                                    <input required id="Reviewer_name" data-maxlength="150" type="text" name="question[]"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea required id="Reviewer_review" data-maxlength="100"
                                          type="text"
