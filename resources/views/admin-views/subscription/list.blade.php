            ...
            <div class="row g-3">
                <div class="col-sm-6 col-lg-3">
                    <a class="__card-2 __bg-1" href="#">
                        ...
                        <img src="{{dynamicAsset('assets/admin/img/subscription-plan/subscribed-user.png')}}" alt="report/new" class="card-icon" width="35px">
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <a class="__card-2 __bg-3" href="#">
                        ...
                        <img src="{{dynamicAsset('assets/admin/img/subscription-plan/active-user.png')}}" alt="report/new" class="card-icon" width="35px">
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <a class="__card-2 __bg-6" href="#">
                        ...
                        <img src="{{dynamicAsset('assets/admin/img/subscription-plan/expired-user.png')}}" alt="report/new" class="card-icon" width="35px">
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <a class="__card-2 __bg-4" href="#">
                        ...
                        <img src="{{dynamicAsset('assets/admin/img/subscription-plan/expired-soon.png')}}" alt="report/new" class="card-icon" width="35px">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-borderless middle-align __txt-14px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4">
                                    <a href="{{route('admin.restaurant.view', $subscriber->id)}}" alt="view restaurant" class="table-rest-info"min-w-280 max-w-315>
                                        <img src="{{ $subscriber->logo_full_url ?? dynamicAsset('assets/admin/img/100x100/1.png') }}" >
                                        <div class="info">
