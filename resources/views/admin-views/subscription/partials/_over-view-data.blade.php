        ...
        <div class="row g-3">
            <div class="col-sm-6 col-lg-3">
                <a class="__card-2 __bg-1" href="#">
                    ...
                    <img src="{{dynamicAsset('assets/admin/img/subscription-plan/subscribed-user.png')}}"
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="__card-2 __bg-3" href="#">
                    ...
                    <img src="{{dynamicAsset('assets/admin/img/subscription-plan/active-user.png')}}"
                        alt="report/new" class="card-icon" width="35px">
                </a>
            </div>
            <div class="col-sm-6 col-lg-3">
                <a class="__card-2 __bg-6" href="#">
                    ...
                    <img src="{{dynamicAsset('assets/admin/img/subscription-plan/expired-user.png')}}"
                        alt="report/new" class="card-icon" width="35px">
                </a>
            </div>
            <div class="col-sm-6 col-lg-3">
                <a class="__card-2 __bg-4" href="#">
                    ...
                    <img src="{{dynamicAsset('assets/admin/img/subscription-plan/expired-soon.png')}}"
                        alt="report/new" class="card-icon" width="35px">
                </a>
            </div>
        </div>
    ...
    <div class="row g-2">
            ...
            <a class="order--card h-100" href="#">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/plan/free.png')}}" alt="dashboard"
        ...
        <div class="col-sm-6 col-lg-4">
            <a class="order--card h-100" href="#">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/plan/renewed.png')}}" alt="dashboard"
                            class="oder--card-icon" width="20">
        ...
        <div class="col-sm-6 col-lg-4">
            <a class="order--card h-100" href="#">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/plan/total.png')}}" alt="dashboard"
                            class="oder--card-icon" width="20">
