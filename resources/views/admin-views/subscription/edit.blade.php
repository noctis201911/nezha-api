            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-start">
                        <img src="{{dynamicAsset('assets/admin/img/subscription/create-package-icon.png')}}" width="24" alt="img">
        ...
        <div class="card mb-20">
            <div class="card-header">
                <div class="w-100 d-flex flex-wrap align-items-start gap-2">
                    <img src="{{dynamicAsset('assets/admin/img/subscription/material-symbols_featured-play-list.png')}}" width="18" alt="img" class="mt-1">
    ...
    <form action="{{ route('admin.subscription.subscription_update',$subscriptionackage->id) }}" method="post">
        ...
        @method('put')
            ...
            <div class="card mb-20">
                <div class="card-header">
                    <div class="w-100 d-flex flex-wrap align-items-start gap-2">
                        <img src="{{dynamicAsset('assets/admin/img/subscription/material-symbols_featured-play-list-2.png')}}" alt="img" class="mt-1">
                        <div class="w-0 flex-grow">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="w-100 d-flex flex-wrap align-items-start gap-2">
                        <img src="{{dynamicAsset('assets/admin/img/subscription/bx_category.png')}}" alt="img" class="mt-1">
                        <div class="w-0 flex-grow">
                            <h5 class="text--title card-title d-flex gap-3 flex-wrap mb-1">
                                <div>
                                    {{ translate('Set_limit') }}
