                                ...
                                <div class="created-package-slide-item">
                                    @if ($key % 2 == 0)
                                        <a class="__card-1 h-100 __bg-1" href="#">
                                            <img src="{{ dynamicAsset('assets/admin/img/plan/basic.png') }}" class="icon"
                                                alt="report/new">
                                        @elseif ($key % 3 == 1)
                                            <a class="__card-1 h-100 __bg-4" href="#">
                                                <img src="{{ dynamicAsset('assets/admin/img/plan/standard.png') }}"
                                                    class="icon" alt="report/new">
                                            @else
                                                <a class="__card-1 h-100 __bg-8" href="#">
                                                    <img src="{{ dynamicAsset('assets/admin/img/plan/pro.png') }}"
                                                        class="icon" alt="report/new">
                                    @endif
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    <div class="max-w-542 mx-auto py-sm-5 py-4">
                        <img class="mb-4" src="{{ dynamicAsset('assets/admin/img/empty-subscription.svg') }}"
                            alt="img">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            <div class="text-center">
                                <img src="{{ dynamicAsset('assets/admin/img/subscription-plan/tick.png') }}"
                                    class="mb-20">
                                <h5 class="modal-title" id="toggle-title"></h5>
                            </div>
                            <div class="text-center" id="toggle-message">
