        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{dynamicAsset('assets/admin/img/captcha.png')}}" class="w--26" alt="">
                </span>
                <span>
                        ...
                        <div class="card">
                            <div class="card-header card-header-shadow">
                                <h5 class="card-title align-items-center">
                                    <img height="20px"
                                    src="{{dynamicAsset('assets/admin/img')}}/{{$socialLoginService['login_medium']}}.png"
                                     class="mr-1 w--20" alt="">
                                    {{translate('messages.'.$socialLoginService['login_medium'])}} &nbsp;
                                    <span class="d-flex align-items-center switch--label">
                                        <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Users_can_sign_in_using_their') }} {{translate($socialLoginService['login_medium'])}} {{ translate('messages.account') }}"><img src="{{dynamicAsset('assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                    </span>
                                </h5>
                                <label class="toggle-switch toggle-switch-sm p-0">
                                    <input id="{{$socialLoginService['login_medium']}}_status"
                                           ...
                                           data-type="toggle"
                                           data-image-on="{{dynamicAsset('assets/admin/img/modal')}}/{{$socialLoginService['login_medium']}}-on.png"
                                           data-image-off="{{dynamicAsset('assets/admin/img/modal')}}/{{$socialLoginService['login_medium']}}-off.png"
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            @csrf
                                <div class="card-header card-header-shadow">
                                    <h5 class="card-title align-items-center">
                                        <img src="{{dynamicAsset('assets/admin/img/apple.png')}}" class="mr-1 w--20" alt="">
                                        {{translate('messages.'.$appleLoginService['login_medium'])}} &nbsp;
                                        <span class="d-flex align-items-center switch--label">
                                            <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Users_can_sign_in_using_their') }} {{translate($appleLoginService['login_medium'])}} {{ translate('messages.account_on_the_IOS_App') }}"><img src="{{dynamicAsset('assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                        </span>
                                    </h5>
                                    <label class="toggle-switch toggle-switch-sm p-0">
                                        <input  id="{{$appleLoginService['login_medium']}}_status"
                                               ...
                                               data-type="toggle"
                                               data-image-on="{{dynamicAsset('assets/admin/img/modal')}}/{{$appleLoginService['login_medium']}}-on.png"
                                               data-image-off="{{dynamicAsset('assets/admin/img/modal')}}/{{$appleLoginService['login_medium']}}-off.png"
            ...
            <div class="modal-content {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                ...
                <div class="modal-body pb-0">
                    <div class="text-center mb-20">
                        <img src="{{dynamicAsset('assets/admin/img/modal/google.png')}}" alt="" class="mb-20">
        ...
        <div class="modal-dialog status-warning-modal">
            <div class="modal-content {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                ...
                <div class="modal-body pb-0"><b></b>
                    <div class="text-center mb-20">
                        <img src="{{dynamicAsset('assets/admin/img/modal/facebook.png')}}" alt="" class="mb-20">
    ...
    <div class="modal fade" id="apple-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog status-warning-modal">
            <div class="modal-content {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                ...
                <div class="modal-body pb-0"><b></b>
                    <div class="text-center mb-20">
                        <img src="{{dynamicAsset('assets/admin/img/modal/apple.png')}}" alt="" class="mb-20">
