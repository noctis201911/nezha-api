        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{dynamicAsset('assets/admin/img/email.png')}}" class="w--26" alt="">
                </span>
                    ...
                    <ul class="nav nav-tabs nav--tabs border-0 gap-2">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="#mail-config" data-toggle="tab" class="nav-link pb-2 px-0 pb-sm-3 active">
                                <img src="{{dynamicAsset('assets/admin/img/mail-config.png')}}" alt="">
                                <span>{{translate('Mail_Config')}}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#test-mail" data-toggle="tab" class="nav-link pb-2 px-0 pb-sm-3">
                                <img src="{{dynamicAsset('assets/admin/img/test-mail.png')}}" alt="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="{{dynamicAsset('assets/admin/img/sent-mail-box.png')}}" alt="" class="mb-20">
                    ...
                    <div class="btn--container justify-content-center">
                        <button type="submit"  class="btn btn--primary min-w-120 show-Tab" data-dismiss="modal">
                            <img src="{{dynamicAsset('assets/admin/img/paper-plane.png')}}" alt=""> {{translate('Send Test Mail')}}
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="single-item-slider owl-carousel">
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{dynamicAsset('assets/admin/img/mail-config/slide-1.png')}}" alt="" class="mb-20">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{dynamicAsset('assets/admin/img/mail-config/slide-2.png')}}" alt="" class="mb-20">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{dynamicAsset('assets/admin/img/mail-config/slide-3.png')}}" alt="" class="mb-20">
                        ...
                        <div class="item">
                            <div class="mw-353px mb-20 mx-auto">
                                <div class="text-center">
                                    <img src="{{dynamicAsset('assets/admin/img/mail-config/slide-4.png')}}" alt="" class="mb-20">
