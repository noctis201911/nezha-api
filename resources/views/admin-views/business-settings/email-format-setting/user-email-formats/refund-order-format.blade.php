...
@push('css_or_js')
<link rel="stylesheet" href="{{dynamicAsset('assets/admin/css/view-pages/email-templates.css')}}">
@endpush
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center __gap-15px">
                <h1 class="page-header-title mr-3 mb-0">
                    <span class="page-header-icon">
                        <img src="{{ dynamicAsset('assets/admin/img/email-setting.png') }}" class="w--26" alt="">
                    </span>
                    <span>
                        ...
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_get_an_automated_email_when_they_receive_a_refund_to_their_wallet_from_Admin_with_refund_details.')}}">
                                    <img src="{{ dynamicAsset('assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.show_hide_food_menu') }}">
                                 </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-id="mail-status"
                                data-type="status"
                                data-image-on='{{dynamicAsset('assets/admin/img/modal')}}/place-order-on.png'
                                data-image-off="{{dynamicAsset('assets/admin/img/modal')}}/place-order-off.png"
                        ...
                        <div class="card-body">
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-3">
                                            <img src="{{dynamicAsset('assets/admin/img/pointer.png')}}" class="mr-2" alt="">
                                ...
                                <div class="max-349 mx-auto mb-20">
                                    <div>
                                        <div class="text-center">
                                            <img src="{{dynamicAsset('assets/admin/img/modal/place-order-off.png')}}" alt="" class="mb-20">
                                    ...
                                    <!-- <div>
                                        <div class="text-center">
                                            <img src="{{dynamicAsset('assets/admin/img/modal/place-order-on.png')}}" alt="" class="mb-20">
...
@push('script_2')
    <!-- Email Template-->
    <script src="{{dynamicAsset('assets/admin/ckeditor/ckeditor.js')}}"></script>
    <script src="{{dynamicAsset('assets/admin/js/view-pages/email-templates.js')}}"></script>
    <!-- Email Template End-->
@endpush
