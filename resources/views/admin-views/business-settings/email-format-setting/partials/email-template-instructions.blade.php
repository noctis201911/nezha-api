            ...
            <div class="modal-body pb-5 pt-0">
                <div class="single-item-slider owl-carousel">
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/1.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/5.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/2.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/3.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/4.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/6.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/7.png')}}" alt="" class="mb-20">
                    ...
                    <div class="item">
                        <div class="mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/email-templates/8.png')}}" alt="" class="mb-20">
