                        ...
                        <form action="{{route('admin.business-settings.storage_connection_update',['local_storage'])}}"
                            ...
                            <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    ...
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If_enabled_System_will_store_all_files_and_images_to_local_storage')}}"><img src="{{dynamicAsset('assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                </span>
                                ...
                                <input
                                    ...
                                    data-type="status"
                                    data-image-on="{{ dynamicAsset('assets/admin/img/modal/local_storage.png') }}"
                                    data-image-off="{{ dynamicAsset('assets/admin/img/modal/local_storage.png') }}"
                        ...
                        <form action="{{route('admin.business-settings.storage_connection_update',['3rd_party_storage'])}}"
                            ...
                            <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    ...
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If_enabled_System_will_store_all_files_and_images_to_3rd_party_storage')}}"><img src="{{dynamicAsset('assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                </span>
                                ...
                                <input
                                    ...
                                    data-type="status"
                                    data-image-on="{{ dynamicAsset('assets/admin/img/modal/3rd_party_storage.png') }}"
                                    data-image-off="{{ dynamicAsset('assets/admin/img/modal/3rd_party_storage.png') }}"
