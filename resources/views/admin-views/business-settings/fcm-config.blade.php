        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{dynamicAsset('assets/admin/img/firebase.png')}}" class="w--26" alt="">
                </span>
                    ...
                    <ul class="nav nav-tabs nav--tabs border-0 gap-2">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link pb-2 px-0 pb-sm-3 active" data-slide="2">
                                <img src="{{dynamicAsset('assets/admin/img/firebase2.png')}}" alt="">
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="max-349 mx-auto mb-20">
                            <div class="text-center">
                                <img src="{{dynamicAsset('assets/admin/img/firebase/slide-4.png')}}" alt="" class="mb-20">
...
@push('script_2')
<script src="{{dynamicAsset('assets/admin/js/view-pages/business-settings-fcm.js')}}"></script>
@endpush
