        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{dynamicAsset('assets/admin/img/firebase_auth.png')}}" class="w--26" alt="">
                </span>
                <span>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <input type="checkbox"
                                                   ...
                                                   data-type="toggle"
                                                   data-image-on="{{ dynamicAsset('assets/admin/img/modal/order-delivery-verification-on.png') }}"
                                                   data-image-off="{{ dynamicAsset('assets/admin/img/modal/order-delivery-verification-off.png') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center my-5">
                        <img src="{{ dynamicAsset('assets/admin/img/modal/bell.png') }}">
                    </div>
