                ...
                <form
                    ...
                    <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control mb-4">
                        ...
                        <input type="checkbox"
                               ...
                               data-type="toggle"
                               data-image-on="{{ dynamicAsset('assets/admin/img/modal/important-recapcha.png') }}"
                               data-image-off="{{ dynamicAsset('assets/admin/img/modal/warning-recapcha.png') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center">
                        <img src="{{dynamicAsset('assets/admin/img/modal/warning-recapcha-2.png')}}" width="80" alt="">
                    </div>
