            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{request('tab')=='payment_info'?'active':''}}" href="{{route('admin.restaurant.view', ['restaurant'=>$restaurant->id, 'tab'=> 'payment_info'])}}"  aria-disabled="true">{{translate('messages.收款信息')}}</a>
                </li>
                <li class="nav-item">
