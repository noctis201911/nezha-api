                    ...
                    <div class="row g-3 align-items-start">
                        <div class="col-md-7">
                            <div class="alert alert-info" style="font-size:13px;line-height:1.7;">
                                ...
                                • <b>BEP20 / 币安智能链</b>（地址 0x 开头）：手续费低很多（通常约 0.1 USDT 上下、远低于波场，以币安实时为准），适合从币安转出的顾客。<br>
                                • <b>两条链平台都会自动上链核验是否真到账</b>（顾客填交易哈希后系统去公链查收款地址/金额/确认）；偶尔链上节点繁忙时会提示商家手动核对。<br>
                                • ⚠️ 地址=钱的去向，务必填商家<b>自己掌控的钱包</b>地址，别填交易所内部充值地址（易被识别成"内部转账"而查不到链上记录）。<br>
                                • <b>没填某种方式就不显示</b>：地址/收款码空着的方式，顾客端<b>直接不显示</b>(例: 只填支付宝→顾客只看到支付宝; BEP20 没填→顾客端不出现 BEP20)，不显示灰色「暂不可用」。
                            </div>
