            ...
            <div class="table-responsive datatable-custom pt-0">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="w-100px">{{ translate('messages.stock') }}</th>
                        @if ($productWiseTax)
                        ...
                        <tr>
                                   ...
                                   href="{{ route('admin.food.view', [$food['id']]) }}">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span>
                                                ...
                                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.Your_main_stock_is_out_of_stock.')}}"><img src="{{dynamicAsset('assets/admin/img/info-icon-bg.svg')}}" class="w-5p" alt="public/img"></span>
                                            @else
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center gap-1">
                                    <span class="lh-1 mt-1">{{ $food->stock_type == 'unlimited' ? translate('messages.N/A') :$food->item_stock }}</span>
                                    <span class="lh-1" data-toggle="tooltip" data-placement="right" data-original-title="{{translate($food->stock_type)}}">
                                        <i class="tio-info brand-base-clr fs-14"></i>
                                    </span>
                                </div>
                            </td>
                            @if ($productWiseTax)
