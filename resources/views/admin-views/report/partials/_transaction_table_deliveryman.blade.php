            ...
            @foreach($transactions as $k => $t)
                <tr>
                    ...
                    @if($type === 'order')
                        ...
                        <td class="text-right">{{ \App\CentralLogics\Helpers::format_currency($t['delivery_charge']) }}</td>
                    ...
                    @elseif($type === 'incentive')
                        ...
                        <td class="text-right">{{ \App\CentralLogics\Helpers::format_currency($t['incentive']) }}</td>
                    @endif
                </tr>
            @endforeach
        </tbody>
