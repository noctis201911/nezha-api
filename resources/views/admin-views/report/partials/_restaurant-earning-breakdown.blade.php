        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                ...
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings_with_admin_commission'] > 0 ? round(($summary['breakdown']['order_sales'] / $summary['total_earnings_with_admin_commission']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                ...
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings_with_admin_commission'] > 0 ? round(($summary['breakdown']['tax_collected'] / $summary['total_earnings_with_admin_commission']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item text-sm-left">
                ...
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings_with_admin_commission'] > 0 ? round(($summary['breakdown']['packaging_fee_collected'] / $summary['total_earnings_with_admin_commission']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
    </div>
