        ...
        <div class="row g-lg-5 gx-3 gy-3 earnings-breakdown">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="item border-right">
                    <div
                        ...
                        <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/order-commission.svg') }}"
                            alt="earning">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="item border-right">
                    <div
                        ...
                        <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/subscription.svg') }}"
                            alt="earning">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="item">
                    <div
                        ...
                        <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/additional-fees.svg') }}"
                            alt="earning">
                    </div>
                    <div class="mb-2">{{translate('messages.Additional Charge') }}</div>
                    <h2 class="font-medium fs-24 fs-18-mobile mb-2">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="item border-right">
                    <div
                        ...
                        <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/other-income.svg') }}"
                            alt="earning">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="item">
                    <div
                        class="flex-shrink-0 info rounded-10 w-40px aspect-1-1 d-flex justify-content-center align-items-center mb-3">
                        <img src="{{ dynamicAsset('assets/admin/img/report/new/admin-earning.png') }}"
                            alt="earning">
                    </div>
                    <div class="mb-2">{{ translate('messages.Express Charge') }}</div>
                    <h2 class="font-medium fs-24 fs-18-mobile mb-2">
                        {{ App\CentralLogics\Helpers::format_currency($earnings['express_charge']) }}</h2>
                    <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                        {{ $earnings['express_charge_percentage'] }}% {{ translate('messages.of Total') }}
                    </div>
                </div>
            </div>
        </div>
