        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                ...
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings'] > 0 ? round(($summary['breakdown']['delivery_charge'] / $summary['total_earnings']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                ...
                <h2 class="font-medium fs-24 fs-18-mobile mb-2">{{ \App\CentralLogics\Helpers::format_currency($summary['breakdown']['incentives'] ?? 0) }}</h2>
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings'] > 0 ? round(($summary['breakdown']['incentives'] / $summary['total_earnings']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item">
                ...
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $summary['total_earnings'] > 0 ? round(($summary['breakdown']['dm_tips'] / $summary['total_earnings']) * 100, 1) : 0 }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
    </div>
