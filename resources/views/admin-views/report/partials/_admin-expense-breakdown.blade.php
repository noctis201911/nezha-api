    ...
    <div class="row g-lg-5 gx-3 gy-3 earnings-breakdown">
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                <div
                    ...
                    <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/free-delivery.svg') }}"
                        alt="earning">
                </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                <div
                    ...
                    <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/coupon-offers.svg') }}"
                        alt="earning">
                </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item">
                ...
                <h2 class="font-medium fs-24 fs-18-mobile mb-2">
                    {{ App\CentralLogics\Helpers::format_currency($expenses['discount_on_product']) }}
                </h2>
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $expenses['discount_on_product_percentage'] }}% {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                <div
                    class="flex-shrink-0 warning rounded-10 w-40px aspect-1-1 d-flex justify-content-center align-items-center mb-3">
                    <img src="{{ dynamicAsset('assets/admin/img/report/new/admin-earning.png') }}" alt="earning">
                </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                <div
                    class="flex-shrink-0 warning rounded-10 w-40px aspect-1-1 d-flex justify-content-center align-items-center mb-3">
                    <img src="{{ dynamicAsset('assets/admin/img/report/new/refunded.png') }}" alt="earning">
                </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="item">
                ...
                <div class="mb-2">{{ translate('messages.Slightly Delay Delivery Charge') }}
                </div>
                <h2 class="font-medium fs-24 fs-18-mobile mb-2">
                    {{ App\CentralLogics\Helpers::format_currency($expenses['slightly_delay']) }}
                </h2>
                <div class="fs-12 bg-light px-2 py-1 rounded-lg w-max-content">
                    {{ $expenses['slightly_delay_percentage'] }}%
                    {{ translate('messages.of Total') }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6">
            <div class="item border-right">
                <div
                    ...
                    <img src="{{ dynamicAsset('assets/admin/img/report/earning-breakdown/tax-payments.svg') }}"
                        alt="earning">
                </div>
                <div class="mb-2">{{ translate('messages.Other') }}
                    <span class="input-label-secondary text--title ml-0 mr-1" data-toggle="tooltip" data-placement="top"
                        data-original-title="{{ translate('Includes User Referral Discounts and Deliveryman Incentives.') }}">
