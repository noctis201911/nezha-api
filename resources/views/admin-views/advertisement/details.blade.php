                        ...
                        <div class="col-md-6">
                            <div class="mb-20">
                                <div class="d-flex align-items-center flex-wrap gap-2 justify-content-md-end approve-buttons">
                                    ...
                                    data-image="{{dynamicAsset('assets/admin/img/modal/deny.png')}}"
                                    data-type="deny"
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.restaurant.view', $advertisement->restaurant_id)}}" class="media align-items-start deco-none resturant--information-single">
                            <div class="avatar avatar-circle">
                                <img class="avatar-img w-75px" src="{{ $advertisement->restaurant['logo_full_url'] ?? dynamicAsset('assets/admin/img/100x100/food-default-image.png') }}" alt="image">
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img src="{{  dynamicAsset('assets/admin/img/modal/timeout.png') }}" class="mb-20">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 pt-0">
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img width="80" src="{{  dynamicAsset('assets/admin/img/modal/tick.png') }}" class="mb-20">
                            <h5 class="modal-title"></h5>
                        </div>
                        <div class="text-center" >
