...
<div class="content container-fluid">
    ...
    <div class="card mb-20">
        <div class="card-body p-30">
            <form id="" class="validate-form global-ajax-form" action="{{route('admin.advertisement.store')}}"  method="POST" enctype="multipart/form-data" >
                @csrf
                @method("POST")
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        @foreach ($language as $lang)
                            ...
                            <div class="d-none lang_form"
                                ...
                                <div class="mb-20">
                                    <label class="form-label">{{ translate('Advertisement_Title') }}   ({{ strtoupper($lang) }}) <span class="text-danger">*</span></label>
                        ...
                        <label class="form-label" for="exampleFormControlSelect1">{{ translate('messages.Select_Restautant') }} <span class="text-danger">*</span></label>
                        <div class="mb-20">
                            <select required name="restaurant_id" id="restaurant_id"  data-placeholder="{{ translate('messages.select_restaurant') }}"
                        ...
                        <div class="mb-20">
                            ...
                            <div class="position-relative">
                                ...
                                <input required type="text" class="form-control h-45 position-relative bg-transparent"  name="dates" placeholder="{{ translate('messages.Select_Date') }}">
                            </div>
                        </div>

                        <div class="promotion-typewise-upload-box" id="video-upload-box">
                            <label class="form-label">{{ translate('Upload Related Files') }} <span class="text-danger">*</span></label>
