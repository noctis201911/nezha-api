                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-20">
                            ...
                            <input type="text" class="form-control" id="title" name="title[]" value="{{  $advertisement?->getRawOriginal('title') }}"
                                   placeholder="{{ translate('Exclusive_Offer') }}" maxlength="255" data-preview-text="preview-title">
                        </div>
                        <div class="form-floating mb-20">
                            <label class="form-label">{{ translate('Short_Description') }}</label>
                            <textarea class="form-control resize-none" id="description"
                                placeholder="{{ translate('Get_Discount') }}" name="description[]" data-preview-text="preview-description">
                                {{$advertisement?->getRawOriginal('description') }}</textarea>
                        </div>
                        @endif
                        ...
                        <div class="mb-20">
                            ...
                            <select class="js-select form-control w-100 promotion_type" name="advertisement_type">
                                <option value="video_promotion" {{ $advertisement?->add_type == 'video_promotion' ? 'selected' : '' }}>
                                    {{ translate('Video_Promotion') }}
                                </option>
                                <option value="restaurant_promotion" {{ $advertisement?->add_type == 'restaurant_promotion' ? 'selected' : '' }} >
                                    {{ translate('restaurant_promotion') }}
                                </option>
                            </select>
                        </div>
                        <div class="mb-20">
