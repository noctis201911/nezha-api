                        ...
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center text-body" href="{{route('admin.restaurant.view', $add?->restaurant_id)}}">
                                    <img class="avatar avatar-lg mr-3" src="{{ $add->restaurant['logo_full_url'] ?? dynamicAsset('assets/admin/img/100x100/food-default-image.png') }}" alt="">
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center gap-2 ml-3" data-toggle="tooltip" title="{{ translate('Expired & Denied ads has no priority.') }}">
                                    <span>{{  translate('N/A') }}</span> <img src="{{dynamicAsset('assets/admin/img/na.png')}}" alt="">
                                </div>
                                @else
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img src="{{dynamicAsset('assets/admin/img/modal/package-status-disable.png')}}" class="mb-20">
