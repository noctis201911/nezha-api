            ...
            <div class="border rounded-10 p-3 p-xxl-20">
                <div class="row g-lg-5 gx-3 gy-3 earnings-breakdown">
                    <div class="col-lg-3 col-sm-6">
                        <div class="item border-right">
                             <div class="flex-shrink-0 danger rounded-10 w-40px aspect-1-1 d-flex justify-content-center align-items-center mb-3">
                                <img src="{{dynamicAsset('assets/admin/img/report/earning-breakdown/free-delivery.svg')}}" alt="earning">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="item border-right">
                             <div class="flex-shrink-0 warning rounded-10 w-40px aspect-1-1 d-flex justify-content-center align-items-center mb-3">
                                <img src="{{dynamicAsset('assets/admin/img/report/earning-breakdown/refunds.svg')}}" alt="earning">
                            </div>
                    ...
                    <div class="">
                        <div class="border-top py-3 d-flex gap-3 justify-content-between align-items-center flex-wrap">
                            <div class="flex-grow-1 d-flex gap-2 align-items-center">
                                ...
                                <div>
                                    <h5 class="fs-13 font-medium mb-0 line--limit-1">Food Fair</h5>
                                    <p class="fs-12 mb-0">Mirpur Zone</p>
                                </div>
                            </div>
                            <div>
            ...
            <div class="col-lg-6">
                <div class="card card-body shadow-none h-100 pb-2">
                    ...
                    <div class="">
                        <div class="border-top py-3 d-flex gap-3 justify-content-between align-items-center flex-wrap">
                            <div class="flex-grow-1 d-flex gap-2 align-items-center">
                                <img class="w-40px aspect-1 object-cover rounded" src="{{dynamicAsset('assets/admin/img/report/earning-breakdown/zone.svg')}}" alt="">
                                <div>
                                    <h5 class="fs-13 font-medium mb-0 line--limit-1">Mirpur Zone</h5>
                            ...
                            <tbody id="set-rows">
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="badge text-warning bg-warning bg-opacity-10 rounded-lg font-medium px-2">{{ translate('messages.Retaurant') }}</div>
                                    </td>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="mb-1">Golden Spoon Diner</div>
                                        <div class="badge text-info bg-info bg-opacity-10 rounded-lg font-medium px-2">{{ translate('messages.Delivery_Man') }}</div>
                                    </td>
                                    <td class="text-center">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="mb-1">Golden Spoon Diner</div>
                                        <div class="badge text-success bg-success bg-opacity-10 rounded-lg font-medium px-2">{{ translate('messages.Tax_Office') }}</div>
                                    </td>
                                    <td class="text-center">
                                        <div class="badge text-dark bg-danger bg-opacity-10 rounded-lg font-regular px-2">{{ translate('messages.Free_Delivery') }}</div>
                                        <div class="fs-12 mt-1">#ORD 100021</div>
