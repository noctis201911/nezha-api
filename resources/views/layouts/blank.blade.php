    ...
    <div class="row">
        <div class="col-md-12">
            <div id="loading" class="initial-hidden">
                <div class="loading--1">
                    <img width="200" src="{{dynamicAsset('assets/front-end/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
...
{{--<script src="{{dynamicAsset('assets/front-end')}}/vendor/jquery/dist/jquery.slim.min.js"></script>--}}
<script src="{{dynamicAsset('assets/admin')}}/js/demo.js"></script>
