...
$__navGroups[] = [
    ...
    'items' => [
        ...
        ['label' => '平台集运申报', 'label_raw' => true, 'route' => route('admin.nezha-consolidation.index'), 'icon' => 'tio-cube', 'active' => Request::is('admin/nezha-consolidation') || Request::is('admin/nezha-consolidation/*'), 'gate' => true],
        ['label' => '集运期次管理', 'label_raw' => true, 'route' => route('admin.nezha-consolidation-rounds.index'), 'icon' => 'tio-shopping-cart', 'active' => Request::is('admin/nezha-consolidation-rounds*'), 'gate' => true],
    ],
];
