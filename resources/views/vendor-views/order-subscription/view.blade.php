                ...
                <ul class="nav nav-tabs page-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{$tab=='pause-log'?'active':''}}" href="{{route('vendor.order.subscription.show', ['subscription'=>$subscription->id])}}?tab=pause-log"  aria-disabled="true">{{translate('messages.pause_log')}}
                            <span data-toggle="tooltip" data-placement="right" data-original-title="{{translate('See_all_paused_subscription_deliveries_of_this_order_ID_and_who_paused_it.')}}" class="input-label-secondary"><img src="{{dynamicAsset('assets/admin/img/info-circle.svg')}}" alt="i"></span></a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center" href="javascript:">
                                <div class="avatar avatar-circle mr-3">
                                        ...
                                        src="{{ $subscription?->customer?->image_full_url ?? dynamicAsset('assets/admin/img/160x160/img1.jpg') }}"
                                        alt="image">
                                </div>
                            ...
                            <div class="single-item-slider owl-carousel">
                                <div class="item">
                                    <div class="max-349 mx-auto mb-20 text-center">
                                        <img src="{{dynamicAsset('assets/admin/img/landing-how.png')}}" alt="" class="mb-20">
                                ...
                                <div class="item">
                                    <div class="max-349 mx-auto mb-20 text-center">
                                        <img src="{{dynamicAsset('assets/admin/img/page-loader.gif')}}" alt="" class="mb-20">
                                ...
                                <div class="item">
                                    <div class="max-349 mx-auto mb-20 text-center">
                                        <img src="{{dynamicAsset('assets/admin/img/notice-3.png')}}" alt="" class="mb-20">
