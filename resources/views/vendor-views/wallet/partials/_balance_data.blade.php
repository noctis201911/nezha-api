    ...
    @endif
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <img class="resturant-icon" src="{{dynamicAsset('assets/admin/img/transactions/image_total89.png')}}" alt="public">
                            ...
                            <div>
                                ...
                                @if ($wallet->balance > 0)
                                    ...
                                    @if( $wallet->balance ==  $wallet_earning )
                                        ...
                                        <span class="subtitle">{{ translate('messages.Withdrawable_Balance') }}

                                        @if ($disbursement_type !=  'manual'  )
                                            <span class="tio-info text-gray1 fs-16"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Withdrawals are currently managed by the admin through auto disbursement') }}">
                                            </span>
                                        @endif
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-4">
                    <div class="resturant-card  bg--3" >
                        ...
                        <img class="resturant-icon" src="{{dynamicAsset('assets/admin/img/transactions/image_pending.png')}}" alt="public">
                    </div>
                </div>
