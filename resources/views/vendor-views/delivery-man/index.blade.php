                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body pt-0 d-flex flex-column">
                            <center class="py-3 my-auto">
                                <img class="initial-78" id="viewer" src="{{dynamicAsset('assets/admin/img/100x100/user2.png')}}" alt="delivery-man image"/>
                            </center>
   ...
   <script>
       "use strict";
        ...
        $('#deliaveryman_form').on('submit', function () {
            const totalFiles = $('#coba input[type="file"]').filter(function() {
                return this.files.length > 0;
            }).length;
            if (totalFiles === 0) {
                toastr.error('Please upload at least one Identity image', { CloseButton: true, ProgressBar: true });
                e.preventDefault();
                return false;
            }
