...
<div class="card">
    <div class="card-body">
        <div class="text-center max-w-700 mx-auto pt-5">
            <img src="{{dynamicAsset('assets/admin/img/advertisement-list.png')}}" class="mw-100 mb-3" alt="">
...
@else
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="page-header-title d-flex align-items-center gap-2">
            <img src="{{dynamicAsset('assets/admin/img/advertisement.png')}}" alt="">
    ...
    <div class="card">
        ...
        <div class="card-header py-2 border-0">
           ...
           <form method="GET" action="{{ route('vendor.advertisement.index') }}">
                ...
                <div class="input--group input-group input-group-merge input-group-flush">
                    <input type="search"
                        name="search_ads"
                        value="{{ request()->search_ads }}"
                        class="form-control"
                        placeholder="{{ translate('Search by Ads ID') }}">
                    <button type="submit" class="btn btn--secondary secondary-cmn">
                                ...
                                <div class="dropdown dropdown-2">
                                    ...
                                    <ul class="dropdown-menu" dir="ltr">
                                        ...
                                        <a class="dropdown-item d-flex gap-2 align-items-center" href="{{ route('vendor.advertisement.edit',$add->id) }}">
                                            ...
                                            data-image="{{dynamicAsset('assets/admin/img/modal/package-status-disable.png')}}"
                                            data-type="resume"
                                        ...
                                        @if($add->status == 'paused')
                                            ...
                                            data-image="{{dynamicAsset('assets/admin/img/modal/resume.png')}}"
                                            data-type="resume"
                                            data-btn_class = "btn-primary"
                                        ...
                                        id="delete-add-{{ $add->id }}"
                                            ...
                                            @else
                                                ...
                                                data-image="{{dynamicAsset('assets/admin/img/modal/delete-icon.png')}}"
                                            @endif
                                            >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <div class="text-center max-w-700 mx-auto">
                    <img src="{{dynamicAsset('assets/admin/img/created.png')}}" class="mw-100 mb-4" alt="">
...
<script>
    ...
    document.querySelectorAll('[name="search_ads"]').forEach(function (element) {
    element.addEventListener("input", function () {
            ...
            if (this.value === "") {
                ...
                url.searchParams.delete("search_ads");
