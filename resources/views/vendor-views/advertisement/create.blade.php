    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-20">
            <div class="card-body p-30">
                <form class="validate-form global-ajax-form" action="{{route('vendor.advertisement.store')}}"  method="POST" enctype="multipart/form-data" >
                    @csrf
                    @method("POST")
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @foreach ($language as $lang)
                                ...
                                <div class="mb-20">
                                    <label class="form-label">{{ translate('Advertisement_Title') }} ({{ translate('Default') }}) <span class="text-danger ps-3px">*</span></label>
                                ...
                                <div class="d-none lang_form"
                                    ...
                                    <div class="mb-20">
                                        <label class="form-label">{{ translate('Advertisement_Title') }}   ({{ strtoupper($lang) }}) <span class="text-danger ps-3px">*</span></label>
                            ...
                            <div class="mb-20">
                                <label class="form-label">
                                    {{ translate('Validity') }}
                                    <span class="text-danger ps-3px">*</span>
                                </label>

                                <div class="position-relative date-field">
                                    <input required type="text" class="form-control h-45 bg-transparent pe-5" name="dates"
                                        placeholder="dd/mm/yyyy - dd/mm/yyyy">

                                    <i class="tio-calendar-month date-icon"></i>
                                </div>
                            </div>
                            ...
                            <div class="promotion-typewise-upload-box" id="profile-upload-box">
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-3 border rounded p-3">
                                    <div class="d-flex flex-column align-items-center gap-3">
                                        <p class="title-color mb-0">{{ translate('Profile Image') }} <span class="text-danger">*</span> <span class="text-danger">({{ translate('Ratio - 1:1') }})</span></p>

                                        <div class="upload-file">
                                            <input required type="file" class="cover_attachment js-upload-input"
                                                data-target="profile-prev-image" name="profile_image"
                                                accept=".png,.jpg,.jpeg,.gif, |image/*">
                                            <div class="upload-file__img">
                                                <img src="{{dynamicAsset('assets/admin/img/media/upload-file.png')}}" alt="" >
                                            </div>
                                            <button class="remove-file-button" type="button">
                                                <i class="tio-clear"></i>
                                            </button>
                                    ...
                                    <div class="d-flex flex-column align-items-center gap-3">
                                        <p class="title-color mb-0">{{ translate('Upload Cover') }} <span class="text-danger">*</span> <span class="text-danger">({{ translate('Ratio - 2:1') }})</span></p>
                                        <div class="upload-file">
                                            <input type="file" class="cover_attachment js-upload-input"
                                                data-target="main-image" name="cover_image"
                                                accept=".png,.jpg,.jpeg,.gif, |image/*">
                                            <div class="upload-file__img upload-file__img_banner">
                                                <img src="{{dynamicAsset('assets/admin/img/media/banner-upload-file.png')}}" alt="" >
                                            </div>
                                            <button class="remove-file-button" type="button">
                                                <i class="tio-clear"></i>
                                            </button>
    ...
    <script>
        ...
        $(window).on('load', function () {
            ...
            $(".video_attachment").closest('.upload-file').find('.remove-file-button').on('click', function () {
                $(this).hide()
                $(this).closest('.upload-file').find('.upload-file__img').html('<img src="{{dynamicAsset('assets/admin/img/media/video-banner.png')}}" alt="">');
                $(this).closest('.upload-file').find('.video_attachment').val('');
                $(this).closest('.upload-file').find('.video > video').css('display', 'none');
                videoEl.css('display', 'none');
                videoEl.attr('src', '');
