            ...
            <form id="create-add-form"  method="post" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    @endforeach
                        ...
                        <div class="mb-20">
                            <label class="form-label">{{ translate('Validity') }} <span class="text-danger ps-3px">*</span></label>
                                ...
                                <div class="d-flex flex-column align-items-center gap-3">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img">
                                            <img src="{{ $advertisement?->profile_image_full_url }}" data-src="{{dynamicAsset('assets/admin/img/media/upload-file.png')}}" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
                                ...
                                <div class="d-flex flex-column align-items-center gap-3">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img upload-file__img_banner">
                                            <img src="{{ $advertisement?->cover_image_full_url }}" data-src="{{dynamicAsset('assets/admin/img/media/banner-upload-file.png')}}" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
