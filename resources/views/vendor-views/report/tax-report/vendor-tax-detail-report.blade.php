                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24">
                            <img src="{{ dynamicAsset('assets/admin/img/tax/1.png') }}" alt="img" class="mb-20">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-primary-5 h-100 rounded p-24">
                            <img src="{{ dynamicAsset('assets/admin/img/tax/2.png') }}" alt="img" class="mb-20">
                    ...
                    <div class="col-lg-12 col-xl-6">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24 d-flex flex-sm-nowrap flex-wrap gap-3">
                            <div class="w-xxl-100 w-sm-50">
                                <img src="{{ dynamicAsset('assets/admin/img/tax/3.png') }}" alt="img" class="mb-20">
    ...
    <script>
        ...
        document.querySelectorAll('[data-order_id]').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const totalTaxRow = document.getElementById('total_tax_row');
                if (taxContainer.innerHTML === '') {
                    totalTaxRow.classList.remove('border-top', 'pt-2');
                } else {
                    totalTaxRow.classList.add('border-top', 'pt-2');
                }
