...
<div class="col-xl-3 col-sm-6">
    ...
    <a class="resturant-card dashboard--card bg--3" href="{{route('vendor.order.list',['cooking'])}}">
        ...
        <img class="resturant-icon max-width-34px" src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/cooking.png')}}" alt="dashboard">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-xl-3 col-sm-6">
    ...
    <a class="resturant-card dashboard--card bg--5" href="{{route('vendor.order.list',['ready_for_delivery'])}}">
        ...
        <img class="resturant-icon max-width-34px" src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/ready.png')}}" alt="dashboard">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-xl-3 col-sm-6">
    ...
    <a class="resturant-card dashboard--card bg--14" href="{{route('vendor.order.list',['food_on_the_way'])}}">
        ...
        <img class="resturant-icon max-width-34px" src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/on-the-way.png')}}" alt="dashboard">
    </a>
    <!-- End Card -->
</div>
    ...
    <div class="row g-2 mt-2">
            ...
            <a href="{{route('vendor.order.list',['delivered'])}}" class="order--card h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/all.png')}}" alt="">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{route('vendor.order.list',['refunded'])}}" class="order--card h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/refunded.png')}}" alt="">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{route('vendor.order.list',['scheduled'])}}" class="order--card h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/scheduled.png')}}" alt="">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{route('vendor.order.list',['all'])}}" class="order--card h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{dynamicAsset('assets/admin/img/resturant-panel/dashboard/top-resturant.png')}}" alt="">
