    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img src="{{dynamicAsset('assets/admin/img/email-template-img.png')}}" alt="">
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                data-onerror-image="{{ dynamicAsset('assets/admin/img/favicon.png') }}" alt="image">
                ...
                <span class="social" style="text-align:center">
                    ...
                    <a href="{{$item->link}}" style="margin: 0 5px;text-decoration:none">
                        <img  src="{{dynamicAsset('assets/admin/img/img/')}}/{{ $item->name }}.png" alt="{{ $item->name }}">
                    </a>
                    @endforeach
                </span>
