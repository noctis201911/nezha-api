...
<body style="background-color: #ececec;">
  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <img src="{{dynamicAsset('assets/admin/img/tick.png')}}" style="height: 50px; width:50px; margin-top:40px;">
                      ...
                      <th>
                          @foreach ($social_media as $item)
                            <div style="display: inline-block;" >
                              ...
                              <img src="{{dynamicAsset('assets/admin/img/'.$item->name.'.png')}}" alt="" style="height: 14px; width:14px; padding: 0px 3px 0px 5px;">
                              </a>
                            </div>
                          @endforeach
                      </th>
