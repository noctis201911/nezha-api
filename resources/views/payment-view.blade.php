                                ...
                                <div class="card-body pt-2 h-70px">
                                    <form action="{{ route('pay-ssl',request()->getQueryString()) }}" method="POST" class="needs-validation" id="ssl-form">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{dynamicAsset('assets/admin/img/sslcomz.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-1 h-70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{dynamicAsset('assets/admin/img/razorpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pb-0 pt-1 h--70px">
                                    <form class="needs-validation" method="GET"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{dynamicAsset('assets/admin/img/paypal.png')}}"/>
                                        </button>
                            ...
                            <div class="card">
                                <div class="card-body py-0 h-70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="checkout-button">
                                        <img width="100" src="{{dynamicAsset('assets/admin/img/stripe.png')}}"/>
                                    </button>
                                ...
                                <div class="card-body py-0 h--70px">
                                    <form id="paymentForm">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit" onclick="payWithPaystack()">
                                          <img width="100" src="{{dynamicAsset('assets/admin/img/paystack.png')}}"/>
                                        </button>
                                      </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-1 h-70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{dynamicAsset('assets/admin/img/senangpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2 h-70px">
                                    <form method="POST" action="{{ route('flutterwave_pay',request()->getQueryString()) }}">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="200"
                                                 src="{{dynamicAsset('assets/admin/img/fluterwave.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2 h-70px">
                                    <a class="btn btn-block click-if-alone" href="{{route('mercadopago.index',request()->getQueryString())}}">
                                        <img width="150"
                                                src="{{dynamicAsset('assets/admin/img/MercadoPago_(Horizontal).svg')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-100px">
                                    <form class="needs-validation" method="POST" id="payment-form-paymob"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="150"
                                                src="{{dynamicAsset('assets/admin/img/paymob.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body h--100px">
                                    <a class="btn btn-block click-if-alone" href="{{route('bkash-make-payment',request()->getQueryString())}}">
                                        <img class="initial--40" src="{{dynamicAsset('assets/admin/img/bkash.png')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-100px">
                                    <button class="btn btn-block click-if-alone mt-n-11px" onclick="location.href='{{route('paytabs-payment')}}'">
                                        <img width="150" src="{{dynamicAsset('assets/admin/img/paytabs.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-100px">
                                    <a class="btn btn-block click-if-alone" href="{{route('paytm-payment',request()->getQueryString())}}">
                                        <img class="initial-70" src="{{dynamicAsset('assets/admin/img/paytm.png')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-100px">
                                    <a class="btn btn-block click-if-alone" href="{{route('liqpay-payment',request()->getQueryString())}}">
                                        <img class="initial-70 mt-0" src="{{dynamicAsset('assets/admin/img/liqpay4.png')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script src="{{dynamicAsset('assets/admin')}}/js/bootstrap.min.js"></script>
