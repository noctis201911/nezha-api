        ...
        <div class="d-flex justify-content-end mb-2 position-absolute top-end">
            <a href="#" class="d-flex align-items-center gap-1">
                        <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                            ...
                            <img src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/info.svg" alt=""
                                 class="svg">
                        </span>
            </a>
        </div>
                                    ...
                                    <label for="phone" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-title="Provide an valid number. This number will be use to send verification code and other attachments in future">
                                                    <img
                                                        src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/info2.svg"
                                                        class="svg" alt="">
                                                </span>
                                    </label>
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="password"
                                               ...
                                               placeholder="Ex: 7+ character" minlength="8">
                                        <div class="togglePassword">
                                            <img
                                                src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
                                            <img
                                                src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/eye-off.svg"
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="confirm_password"
                                               name="confirm_password" class="form-control" placeholder="Ex: 7+ character" required>
                                        <div class="togglePassword">
                                            <img
                                                src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
