                   ...
                   target="_blank">
                    ...
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                          data-bs-title="Follow our documentation">
                                ...
                                <img src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/info.svg"
                                     class="svg" alt="">
                            </span>
                </a>
            </div>
                    ...
                    <div class="row g-4 g-md-5">
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                        src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/php-version.svg"
                                        alt="">
                                <div
                                    ...
                                    @if ($phpVersion >= 8.2)
                                        <img width="20"
                                             src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/check.png"
                                             alt="">
                                    @else
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-title="Your php version in server is lower than 8.2 version
                                                ...
                                                <img
                                                        src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/info.svg"
                        ...
                        @foreach($permission as $key => $item)
                            @if ($key != 'db_file_write_perm' && $key != 'routes_file_write_perm' && $key != 'config_file_write_perm')
                                <div class="col-md-6">
                                    <div class="d-flex gap-3 align-items-center">
                                        <img src="{{ dynamicAsset('assets/installation') }}/assets/img/svg-icons/curl-enabled.svg" alt="">
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                            {{ translate($key) . ' ' . translate('Enabled') }}

                                            @if ($item)
                                                <img width="20" src="{{ dynamicAsset('assets/installation') }}/assets/img/svg-icons/check.png" alt="">
                                            @else
                                                <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                      data-bs-html="true" data-bs-delay='{"hide":1000}'
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                        src="{{dynamicAsset('assets/installation')}}/assets/img/svg-icons/route-service.svg"
                                        alt="">
                                <div
                                        class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    .env File Permission
