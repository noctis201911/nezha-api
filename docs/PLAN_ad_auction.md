...
| 广告位标识 | 首页横滑卡保留现有「推广」标；**餐厅列表竞价位不打标**（业主 2026-07-01 决定，见 §6） |
...
- **INV-5**　付费排序位标识：**首页位保留「推广」标；列表竞价位不打标**（业主决策，§6）。
...
- **列表位不打标（业主决策 · 风险留痕）**：业主 2026-07-01 决定餐厅列表竞价位不打「推广/广告」标。背景：现有 CPT 列表加权本就不打标，属维持现状、非新增欺骗面；首页横滑卡保留标。风险（已知接受、**非 L1 红线**）：出价驱动比拉平加权更接近纯付费位，若亚美尼亚消费者保护执法趋严，列表位是暴露面。INV-5 据此为「首页打标、列表不打标」。
