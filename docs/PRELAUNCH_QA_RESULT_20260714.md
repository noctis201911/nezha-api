...
6. 通知 R2 只有本地语义/编译证据；应用新增的 2 个 API migration 未执行，Firebase 配置/release signing/Play 审核、物理设备矩阵和真实 FCM/邮件/Telegram 回执均未关闭。不得部署或运行 migration 来补证据。
