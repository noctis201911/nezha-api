...
--
-- Host: localhost
-- Generation Time: Apr 12, 2026 at 09:23 AM
...
INSERT INTO `categories` (`id`, `name`, `image`, `parent_id`, `position`, `status`, `created_at`, `updated_at`, `priority`, `slug`, `meta_title`, `meta_description`, `meta_image`, `meta_data`) VALUES
(1, 'Demo Category', '2024-11-20-673de06ce3aa7.png', 0, 0, 1, '2023-09-08 16:29:05', '2024-11-19 23:13:16', 0, 'demo-category', NULL, NULL, NULL, NULL),
(2, 'Demo Sub Category', 'def.png', 1, 1, 1, '2023-09-08 16:29:46', '2023-09-08 16:29:46', 0, 'demo-sub-category', NULL, NULL, NULL, NULL);
...
INSERT INTO `cuisines` (`id`, `name`, `image`, `status`, `slug`, `created_at`, `updated_at`, `meta_title`, `meta_description`, `meta_image`, `meta_data`) VALUES
(1, 'Demo Cuisine', '2024-11-20-673de04034619.png', 1, 'demo-cuisine', '2023-09-08 16:25:54', '2024-11-19 23:12:32', NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `delivery_man_devices`
--

CREATE TABLE `delivery_man_devices` (
  `id` bigint UNSIGNED NOT NULL,
  `delivery_man_id` bigint UNSIGNED NOT NULL,
  `device_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `device_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `biometric_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `delivery_man_shift`
--

CREATE TABLE `delivery_man_shift` (
  `id` bigint UNSIGNED NOT NULL,
  `delivery_man_id` bigint UNSIGNED NOT NULL,
...
(425, '2025_11_09_014948_create_page_seo_data_table', 102),
(426, '2025_11_09_092429_add_to_col_restaurants_table', 102),
(427, '2025_11_10_045854_add_is_default_col_to_zones_table', 102),
(428, '2025_11_10_050952_add_meta_data_to_categories_table', 102),
(429, '2025_11_10_074848_add_meta_data_to_cuisines_table', 102),
(430, '2025_11_11_181052_add_status_col_to_disbursement_withdrawal_methods_table', 102),
(431, '2025_11_17_174803_create_item_campaig_nutrition_table', 102),
(432, '2025_11_17_174833_create_allerg_item_campaigs_table', 102),
(433, '2025_12_01_112958_add_is_default_column_to_customer_addresses_table', 103),
(434, '2025_12_03_185046_add_user_type_&_to_notification_messages_table', 103),
(435, '2025_12_04_124817_add_opening_and_same_time_cols_to_restaurant_configs_table', 103),
(436, '2025_12_11_225018_add_current_language_key_on_delivery_men_table', 103),
(437, '2025_12_11_231934_add_current_language_key_on_vendors_table', 103),
(438, '2026_01_18_032508_create_delivery_man_shift_table_and_update_shifts_table', 104),
(439, '2026_01_22_112233_add_reference_id_column_to_loyalty_point_transactions_table', 104),
(440, '2026_01_22_124449_add_reference_id_column_to_wallet_transactions_table', 104),
(441, '2026_01_25_121925_add_reply_at_col_and_indexes_for_reviews_table', 104),
(442, '2026_03_08_102425_add_delivery_type_settings_to_zones_table', 105),
(443, '2026_03_08_103029_create_zone_delivery_options_table', 105),
(444, '2026_03_08_130942_add_delivery_type_and_delivery_type_charge_column_to_orders_table', 105),
(445, '2026_03_09_101721_create_delivery_man_devices_table', 105),
(446, '2026_03_29_130122_add_minimum_delivery_charge_to_zones_table', 105);
...
CREATE TABLE `restaurant_configs` (
  ...
  `opening_closing_status` tinyint(1) NOT NULL DEFAULT '0',
  `same_time_for_every_day` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `shifts` (`id`, `name`, `start_time`, `end_time`, `status`, `is_full_day`, `created_at`, `updated_at`) VALUES
(1, 'Full Day', '00:00:00', '23:59:59', 1, 1, '2026-02-03 20:03:20', '2026-02-03 20:03:20');
...
INSERT INTO `vendors` (`id`, `f_name`, `l_name`, `phone`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `bank_name`, `branch`, `holder_name`, `account_no`, `image`, `status`, `firebase_token`, `auth_token`, `fcm_token_web`, `current_language_key`) VALUES
(1, 'Demo', 'Restaurant', '01700000000', 'Demo@Restaurant.com', NULL, '$2a$12$NQBXTu9.U.jS0McEJPVEZuVcC2eAorHB8vQXCPlbcXuJM/mb9RpfO', NULL, '2023-09-08 16:35:02', '2023-09-08 16:35:02', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'en');
...
CREATE TABLE `zones` (
  ...
  `minimum_delivery_time` int DEFAULT NULL COMMENT 'Minimum delivery time in minutes',
...
CREATE TABLE `zone_delivery_options` (
  ...
  `add_delivery_time` int DEFAULT NULL COMMENT 'in minutes',
  `reduce_delivery_time` int DEFAULT NULL COMMENT 'in minutes',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `allergy_item_campaign`
  ADD PRIMARY KEY (`id`),
  ADD KEY `allergy_item_campaign_item_campaign_id_index` (`item_campaign_id`),
  ADD KEY `allergy_item_campaign_allergy_id_index` (`allergy_id`);
...
--
-- Indexes for table `delivery_man_devices`
--
ALTER TABLE `delivery_man_devices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `delivery_man_devices_device_id_unique` (`device_id`);

--
-- Indexes for table `delivery_man_shift`
--
ALTER TABLE `delivery_man_shift`
  ADD PRIMARY KEY (`id`),
  ADD KEY `delivery_man_shift_delivery_man_id_foreign` (`delivery_man_id`),
  ADD KEY `delivery_man_shift_shift_id_foreign` (`shift_id`);
...
ALTER TABLE `item_campaign_nutrition`
  ADD PRIMARY KEY (`id`),
  ADD KEY `item_campaign_nutrition_item_campaign_id_index` (`item_campaign_id`),
  ADD KEY `item_campaign_nutrition_nutrition_id_index` (`nutrition_id`);
...
--
-- Indexes for table `zone_delivery_options`
--
ALTER TABLE `zone_delivery_options`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `delivery_man_devices`
--
ALTER TABLE `delivery_man_devices`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `delivery_man_shift`
--
ALTER TABLE `delivery_man_shift`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `migrations`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=447;
...
--
-- AUTO_INCREMENT for table `zone_delivery_options`
--
ALTER TABLE `zone_delivery_options`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `delivery_man_shift`
--
ALTER TABLE `delivery_man_shift`
  ADD CONSTRAINT `delivery_man_shift_delivery_man_id_foreign` FOREIGN KEY (`delivery_man_id`) REFERENCES `delivery_men` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `delivery_man_shift_shift_id_foreign` FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`id`) ON DELETE CASCADE;
COMMIT;
