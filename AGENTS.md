...
- [ ] Codex(商家隔离浏览器 QA·2026-07-14) 正在最新 origin/main 独立工作树验证自动下线/自助恢复、双商家会话隔离与 `/m` 本地生活商家自助链路；初始改动范围仅 tests/Support/IsolatedDatabaseFixtures.php、目标测试及隔离 QA 工件，若证实生产代码缺陷会先追加精确文件认领再修改。不部署、不写生产数据/配置、不迁移生产库、不新增产品状态或安全边界。
