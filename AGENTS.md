...
- [ ] Claude(Fable·P1a商家后台收敛) 正在改 vendor _sidebar.blade.php(仅pending li封存) / order/list.blade.php(仅nzStatusTabs数组移除pending) / partials/_todo-actionbar.blade.php(待处理card封存) / dashboard.blade.php(订单统计彩瓦card封存) —— P1a纯删减·业主已批。⚠️ 改动停留工作树【待业主视觉点头后才commit+push+deploy·防nzdeploy连带上线(ec44d2c教训)】, 其间请勿提交/覆盖这4文件; 回滚点=各文件.bak.p1a.202607022350（2026-07-03 00:05）
