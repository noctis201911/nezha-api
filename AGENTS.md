...
- [ ] Claude(职员编号窗口·B) 正在改 Admin/EmployeeController+CustomRoleController + custom-role/employee blades + 迁移(admins.employee_code / admin_roles.code_prefix) —— 超管职员编号 CS-001 自动生成 (2026-07-01)