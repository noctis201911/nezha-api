...
- [x] Codex(USDT 安全治理方案·2026-07-14) ✅隔离分支方案已完成：AGENTS.md + docs/USDT_PAYMENT_SECURITY_GOVERNANCE.md + docs/SECURITY_QA_PLAYBOOK.md。已按当前生产运行版本/脏树重核，记录 6 项证据化风险、默认关闭的地址变更状态机、CSP 收敛、DMARC/DNSSEC、仿冒举报及逐项影响/测试/回滚/授权停点；未部署、未迁移、未改 DNS/nginx/生产配置/正式 UI，资金规则仍待业主裁决。
