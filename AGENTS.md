...
- [ ] Codex(商家自助/自动下线隔离SQLite回归·2026-07-14) 正在修 tests/Support/IsolatedDatabaseFixtures.php：只补 NezhaLocalMerchantSelfserveE2ETest / NezhaAutoOfflineTest 所需最小共享 schema+seed，先证夹具缺口后回归；不改 migration/生产代码/配置/数据，不部署。
