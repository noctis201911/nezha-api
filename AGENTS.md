...
- [ ] Claude(转人工窗口·A) 正在改 NezhaCsClassifier(isHumanHandoffRequest)+NezhaCsAssistant(转人工分支/在线时段/静默/工单/告警)+Helpers(sendTelegramCsHandoff) —— 明确转人工→在线时段接入真人/非时段留言+告警超管TG (2026-07-01)