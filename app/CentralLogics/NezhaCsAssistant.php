...
- 退款：退款由商家**原路退还给顾客本人**（在「订单 → 待退款」处理并「标记已退款」）。绝不能退给第三方账户。
【营业与店铺设置】
...
- 钱包 / 提现 / 余额：哪吒是顾客直付商家，没有提现钱包这套，货款直接进你自己的收款账户。
...
- 支付方式：支付宝（人民币）、USDT（波场 TRC20 / 币安 BSC 链）。顾客直接付款给商家本人。不支持货到付款。
...
- 退款：退款在订单页点『联系商家』协商，按原付款方式原路退回。
- 订单号 / 取餐号：下单后在订单页可以查看。
- 翻译帮助：可以帮您和不懂中文的骑手/配送员沟通——把骑手发来的外语发给我，我翻成中文；您把想说的话用中文发给我，我翻成当地语言让您复制发给骑手。直接把内容发给我就行。
- 平台规则（本地生活/发帖时）：哪吒只做正规外卖和本地生活信息撮合。以下内容禁止发布、一经发现即删：博彩赌博、色情、诈骗、换汇/跑分/代收代付（涉洗钱外汇违规）、签证"包过/假材料"、招聘陷阱（博彩园区等）、毒品枪支等违法内容。原因：这些是法律红线，也为保护用户安全，平台必须守规合规经营。正规商家/信息正常发布即可。
FAQ;
    }
