...
class NezhaCsClassifier
{
    ...
    protected static array $sensitive = [
        ...
        // —— 口语化退款变体 ——
        '把钱退我', '钱退回', '退回来', '啥时候退', '什么时候退', '退款到哪', '退款进度', '我的退款', '给我退', '退了吧', '能退吗', '可以退吗', '退不退', '怎么退款', '怎么退钱', '退一半', '退部分', '退差价', '多退少补', '退我一下',
        // —— 口语化扣款/多收/被坑 ——
        '钱怎么没', '钱不见', '白扣', '扣我钱', '钱被扣', '钱扣了', '付了两次', '付了两遍', '扣了两次', '扣两次', '多算', '算多', '收费不对', '收贵', '被坑', '坑钱', '骗钱', '黑店',
        // —— 口语化漏发/没送到 ——
        '餐没到', '外卖没到', '东西没到', '没人送', '没送来', '一直没送',
        // —— 英文口语 ——
        'refund me', 'pay me back', 'where is my money', 'paid twice', 'give me my money',
