...
class CustomerOverviewReportExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('file-exports.customer-overview-report', [
            'data' => $this->data,
        ]);
    }
    ...
    public function styles(Worksheet $sheet) {
        $sheet->getStyle('A5:J5')->getFont()->setBold(true)->getColor()
        ->setARGB('FFFFFF');
