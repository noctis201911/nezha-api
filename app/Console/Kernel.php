...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // Unified customer email-auth attempts contain encrypted PII and are
        // useful only for a short verification window.
        $schedule->command('nezha:purge-customer-email-auth-challenges')
            ->everyFifteenMinutes()
            ->withoutOverlapping();
    }
