    ...
    public function generate_disbursement()
    {
        ...
        foreach ($delivery_mans as $delivery_man){
            if(isset($delivery_man->wallet)){
                ...
                $total_earning = $delivery_man->wallet->total_earning;
                $total_withdraw = $delivery_man->wallet->total_withdrawn + $delivery_man->wallet->pending_withdraw;
                $total_cash_in_hand = $delivery_man->wallet->collected_cash;
