...
class DeliverymanEarningReportController extends Controller
{
    ...
    {
        $delivery_men = DeliveryMan::orderBy('f_name')->get(['id', 'f_name', 'l_name']);
    ...
    public function getDeliverymanEarningSummary(Request $request)
    {
        ...
        $summary = $this->get_deliveryman_earning_summary_data($delivery_man_id, $filter, $from, $to);
    ...
    public function getDeliverymanEarningTrend(Request $request)
    {
        ...
        $trends = $this->get_deliveryman_earning_trend_data($delivery_man_id, $filter, $from, $to);
