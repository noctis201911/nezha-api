                            ...
                            <div id="usersExportDropdown"
                                ...
                                <a id="export-excel" class="dropdown-item"
                                    ...
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        src="{{ dynamicModuleAsset('TaxModule', 'assets/admin/img/excel.svg') }}"
                                ...
                                <a id="export-csv" class="dropdown-item"
                                    ...
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        src="{{ dynamicModuleAsset('TaxModule', 'assets/admin/img/placeholder-csv-format.svg') }}"
                                        alt="Image Description">
            ...
            @else
                <div class="bg--F6F6F6 tax-error__table w-100 h225-vh py-5">
                    <div class="max-349 text-center mx-auto my-5">
                        <img src="{{ dynamicModuleAsset('TaxModule', 'assets/admin/img/tax-error.png') }}" alt="img"
                            class="mb-20">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{ dynamicModuleAsset('TaxModule', 'assets/admin/img/status-ons.png') }}" class="mb-20"
                        alt="">
...
@push('script_2')
    <script src="{{ dynamicModuleAsset('TaxModule', 'assets/js/admin/toastr_notification.js') }}" defer></script>
    <script src="{{ dynamicModuleAsset('TaxModule', 'assets/js/admin/taxvat.js') }}"></script>
